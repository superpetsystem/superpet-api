...
async function test3_UpdateCartStatus(cartId) {
  console.log('🧪 Teste 3: Atualizar status do carrinho');
  try {
...
async function test4_ListCartsByStore() {
  console.log('🧪 Teste 4: Listar carrinhos por loja');
  try {
...
async function test5_SearchCarts() {
  console.log('🧪 Teste 5: Buscar carrinhos');
  try {
...
async function runAllTests() {
  ...
  try {
    ...
    await test3_UpdateCartStatus(cartId);
    await test4_ListCartsByStore();
    await test5_SearchCarts();
...
module.exports = {
  ...
  test1_CreateCart,
  test2_GetCart,
  test3_UpdateCartStatus,
  test4_ListCartsByStore,
  test5_SearchCarts,
};
